  ...
  <div class="container">
    ...
    <div class="grid grid-2">
      ...
      <div class="card fade-in-up">
        <div class="card-body">
          <h3 style="color: #667eea; margin-bottom: 2rem;">Informasi Kontak</h3>
          ...
          <div style="display: flex; align-items: center; margin-bottom: 1.5rem;">
            ...
            <div>
              ...
              <p style="color: #666; margin: 0;">Jl. Mpo Nori RT 09 RW 03 Bambu Apus, Cipayung, Jakarta Timur</p>
            </div>
          </div>
      ...
      <div class="card fade-in-up">
        <div class="card-body">
          <h3 style="color: #667eea; margin-bottom: 2rem;">Kirim Pesan</h3>
      ...
      <div class="card-body" style="padding: 0;">
        <div style="background: #f0f0f0; height: 400px; display: flex; align-items: center; justify-content: center; border-radius: 16px;">
          <div style="text-align: center; color: #666;">
            ...
            <h3>Peta Lokasi</h3>
            <p>Jl. Mpo Nori RT 09 RW 03 Bambu Apus, Cipayung, Jakarta Timur</p>
            <a href="https://maps.app.goo.gl/MJbnf5GPboUXtqUx8" target="_blank" class="btn btn-outline" style="margin-top: 1rem;">Buka di Google Maps</a>
          </div>
        </div>
      </div>
    </div>
