  ...
  <div class="container">
    ...
    <div class="grid grid-2">
      <div class="card fade-in-up">
        <div class="card-body">
          <h3 style="color: #667eea; margin-bottom: 1.5rem;">Data Sekolah</h3>
      ...
      <div class="card fade-in-up">
        <div class="card-body">
          <h3 style="color: #667eea; margin-bottom: 1.5rem;">Tentang Sekolah</h3>
...
<section class="section" style="background: #f8f9fa;">
  <div class="container">
    ...
    <div class="grid grid-2">
      <div class="card fade-in-up">
        <div class="card-body">
          <div style="width: 60px; height: 60px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 50%; margin-bottom: 1.5rem; display: flex; align-items: center; justify-content: center;">
...
<section class="section">
  <div class="container">
    ...
    <div class="card fade-in-up" style="margin-top: 3rem;">
      <div class="card-body">
        <h3 style="color: #667eea; margin-bottom: 1.5rem;">Mitra Industri</h3>
  ...
  <div class="container">
    ...
    <div class="card fade-in-up">
      <div class="card-body">
        <div class="grid grid-2">
          <div>
            <h3 style="color: #667eea; margin-bottom: 1.5rem;">Kegiatan Rutin</h3>
          ...
          <div>
            <h3 style="color: #667eea; margin-bottom: 1.5rem;">Prestasi</h3>
            <ul style="color: #666; padding-left: 1.5rem;">
