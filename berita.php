        ...
        <div class="card fade-in-up news-card">
          <div class="card-body">
            <div style="display: flex; align-items: center; margin-bottom: 1rem;">
              <div style="width: 40px; height: 40px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-right: 1rem;">
...
<!-- <section class="section" style="background: #f8f9fa;">
  <div class="container">
    <div class="card fade-in-up" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; text-align: center;">
      <div class="card-body">
        ...
        <div style="display: flex; gap: 1rem; max-width: 400px; margin: 0 auto;">
          ...
          <button class="btn btn-outline" style="background: white; color: #667eea; border-color: white;">Berlangganan</button>
        </div>
      </div>
    </div>
  </div>
