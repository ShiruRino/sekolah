    ...
    <div class="card fade-in-up">
      <div class="card-body">
        <table class="profile-table">
          ...
          <tr>
            <th>Alamat</th>
            <td>Jl. Mpo Nori RT 09 RW 03 Kel. Bambu Apus, Kec. Cipayung, Kota Jakarta Timur DKI Jakarta</td>
          </tr>
          <tr>
  ...
  <div class="container">
    <div class="card" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; text-align: center;">
      <div class="card-body">
        ...
        <a href="kontak.php" class="btn btn-outline" style="background: white; color: #667eea; border-color: white;">Hubungi Kami</a>
      </div>
    </div>
  </div>
</section>
